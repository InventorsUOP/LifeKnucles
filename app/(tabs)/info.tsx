...
const InfoPage: React.FC<InfoPageProps> = ({ navigation }) => {
  ...
  return (
    <ImageBackground source={images.backgroundImage} className="flex-1 resize-cover">
      <ScrollView className="flex-1 p-4 bg-white bg-opacity-90">
        <View className="flex flex-row items-center mb-5">
          ...
          />
          <TextInput placeholder="Search..." className="flex-1 h-10 border border-gray-300 rounded-lg px-3" />
        </View>
        ...
        <View className="mt-0 p-2 bg-gray-100 rounded-lg">
          <Text className="text-red-500 m-5 italic">Developed By: Inventors Club University Of Peradeniya</Text>
        </View>
      </ScrollView>
    </ImageBackground>
  );
