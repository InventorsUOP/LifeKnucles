...
export const WildFirePage = {
  ...
  descriptions: [
    ...
    },
    {
      ...
      content:
        "The Knuckles Mountain Range is characterized by its rugged terrain, varied vegetation, and high rainfall. This unique environment includes tropical forests, grasslands, and montane forests, all of which influence wildfire behavior and risks.",
    },
    {
    ...
    },
    {
      ...
      content:
        "Lightning strikes are a common natural cause of wildfires. During thunderstorms, lightning can ignite dry vegetation, especially in the drier months. Although the Knuckles region receives substantial rainfall, dry periods can still occur.",
    },
    {
      subtitle: "Human Activities",
      content:
        "Human activities are significant contributors to wildfires, including Agricultural Burning, Campfires and Cigarettes, and Illegal Land Clearing.",
    },
    {
      subtitle: "Contributing Factors",
      content:
        "Several factors influence how wildfires spread, including Vegetation Type and Condition, Weather Conditions, and Topography.",
    },
    {
    ...
    },
    {
      ...
      content:
        "Efforts to prevent and manage wildfires include Public Awareness, Controlled Burns, and Firebreaks and Monitoring.",
    },
  ],
};